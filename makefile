...
.PHONY: test-cicd
test-cicd:
	uv run pytest -n 3 tests --ignore=tests/integration/test_webvoyager_scripts.py --ignore=tests/examples/test_examples.py --ignore=tests/examples/test_readme.py --durations=10
