...
from notte.pipe.action_listing.base import BaseActionListingPipe, RetryPipeWrapper
from notte.pipe.action_listing.parser import (
...
def MainActionListingPipe(
    ...
    config: ActionListingConfig | None = None,
