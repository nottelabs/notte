...
class BaseClient(ABC):
    ...
    def __init__(
        ...
        Args:
            root_client: The root NotteClient instance.
        ...
        """
        self.root_client: "NotteClient" = root_client
    ...
    def health_check(self) -> None:
        ...
        try:
            response = self._http.get(f"/{self.HEALTH_CHECK_ENDPOINT}")
    ...
    def request_download(self, url: str, file_path: str) -> bool:
        ...
        with httpx.Client() as client:
            with client.stream("GET", url, timeout=self.DEFAULT_REQUEST_TIMEOUT_SECONDS) as r:
                _ = r.raise_for_status()
                with open(file_path, "wb") as f:
                    for chunk in r.iter_bytes(chunk_size=self.DEFAULT_FILE_CHUNK_SIZE):
                        _ = f.write(chunk)
        return True
