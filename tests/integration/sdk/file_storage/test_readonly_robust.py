...
def test_download_file_action_is_strictly_readonly():
    ...
    # Mock browser opening to avoid GUI popups during test
    with patch("notte_sdk.endpoints.sessions.open_browser"):
        ...
        with readonly_filesystem():
            try:
                ...
                with client.Session(storage=storage, open_viewer=True) as session:
                    ...
                    time.sleep(2)  # reduced sleep for test speed
