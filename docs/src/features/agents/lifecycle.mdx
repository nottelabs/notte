...
See <Visibility for="humans">[Agent Fallback](/features/agents/fallback)</Visibility><Visibility for="agents">[Agent Fallback](/features/agents/fallback.md)</Visibility> for details.
...
<CardGroup cols={2}>
  ...
  <Visibility for="agents">
    <Card title="Configuration" icon="sliders" href="/features/agents/configuration.md">
      Configure agent parameters
    </Card>
  </Visibility>
  ...
  <Visibility for="agents">
    <Card title="Replay" icon="circle-play" href="/features/agents/replay.md">
      Debug with visual replays
    </Card>
  </Visibility>
</CardGroup>
