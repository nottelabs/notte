...
<CardGroup cols={2}>
  ...
  <Visibility for="agents">
    <Card title="Actions" icon="hand-pointer" href="/sdk-reference/manual/session.md">
      Available session actions
    </Card>
  </Visibility>
  ...
  <Visibility for="agents">
    <Card title="Agent Configuration" icon="sliders" href="/features/agents/configuration.md">
      Optimize agent runs
    </Card>
  </Visibility>
