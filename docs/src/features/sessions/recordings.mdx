...
<CardGroup cols={2}>
  ...
  <Visibility for="agents">
    <Card title="Session Lifecycle" icon="clock" href="/features/sessions/lifecycle.md">
      Understand session management
    </Card>
  </Visibility>
  ...
  <Visibility for="agents">
    <Card title="Playwright" icon="code" href="/features/sessions/playwright.md">
      Connect with Playwright via CDP
    </Card>
  </Visibility>
  ...
  <Visibility for="agents">
    <Card title="Agent Replay" icon="robot" href="/features/agents/replay.md">
      Agent-specific replay features
    </Card>
  </Visibility>
</CardGroup>
