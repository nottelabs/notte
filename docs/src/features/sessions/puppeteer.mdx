...
<CardGroup cols={2}>
  ...
  <Visibility for="agents">
    <Card title="Connect with Selenium" icon="globe" href="/features/sessions/selenium.md">
      Use Selenium with Notte sessions
    </Card>
  </Visibility>
  ...
  <Visibility for="agents">
    <Card title="External Browser Providers" icon="cloud" href="/features/sessions/external-providers.md">
      Connect Notte to Kernel.sh and other providers
    </Card>
  </Visibility>
