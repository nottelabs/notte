...
<Tip>
  See the <Visibility for="humans">[Kernel.sh Integration](/integrations/kernel)</Visibility><Visibility for="agents">[Kernel.sh Integration](/integrations/kernel.md)</Visibility> guide for complete setup instructions and examples.
</Tip>
