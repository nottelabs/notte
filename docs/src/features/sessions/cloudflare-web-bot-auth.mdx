...
<Note>
  Web bot auth proves your identity cryptographically, which is fundamentally different from <Visibility for="humans">[stealth mode](/features/sessions/stealth-mode)</Visibility><Visibility for="agents">[stealth mode](/features/sessions/stealth-mode.md)</Visibility> (which hides your identity) or <Visibility for="humans">[proxies](/features/sessions/proxies)</Visibility><Visibility for="agents">[proxies](/features/sessions/proxies.md)</Visibility> (which mask your IP). These approaches are complementary — combining them gives you the broadest coverage.
</Note>
