...
See <Visibility for="humans">[Scraping](/concepts/scraping)</Visibility><Visibility for="agents">[Scraping](/concepts/scraping.md)</Visibility> for detailed documentation.
...
See <Visibility for="humans">[Personas](/concepts/personas)</Visibility><Visibility for="agents">[Personas](/concepts/personas.md)</Visibility> for details.
...
<CardGroup cols={2}>
  ...
  <Visibility for="agents">
    <Card title="Session Configuration" icon="sliders" href="/features/sessions/configuration.md">
      Configure session behavior
    </Card>
  </Visibility>
  ...
  <Visibility for="agents">
    <Card title="SDK Actions Reference" icon="code" href="/sdk-reference/manual/session.md">
      Detailed API documentation
    </Card>
  </Visibility>
  ...
  <Visibility for="agents">
    <Card title="Agent Mode" icon="sparkles" href="/concepts/agents.md">
      Let AI handle actions automatically
    </Card>
  </Visibility>
</CardGroup>
