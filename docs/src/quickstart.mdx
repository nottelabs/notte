...
<CardGroup cols={3}>
<Card title="Browser Session" icon="browser" href="/quickstart"></Card>
<Card title="Browser Agent" icon="alien-8bit" href="/python-sdk"></Card>
<Card title="Web Scraping" icon="globe" href="https://console.notte.cc"></Card>
</CardGroup>
