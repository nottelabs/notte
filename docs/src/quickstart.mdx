...
<div className="notte-fast-setup">
  <div className="notte-fast-setup__body">
    <p>
      Copy this into your AI coding agent (Codex, Claude Code, Cursor, or Windsurf). It installs the Notte skill, checks the CLI, authenticates your account, and opens a live browser session that you or your agent can control.
    </p>
    <button
      type="button"
