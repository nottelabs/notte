---
title: "run"
description: "Run the function using the specified version and variables"
---
...
> Make sure that the correct variables are provided based on the python file previously uploaded. Otherwise, the function will fail.

You can use `local=True` to run the function locally if you have access to the decryption key
