...
<CardGroup cols={3}>
  ...
  <Card title="OpenAPI Spec" icon="code" href="/openapi.json">
    Access the machine-readable API contract directly from the docs domain.
  </Card>
</CardGroup>

If you want the API surface directly, go to [API Reference](/api-reference/authentication). If you want the SDK entrypoint, go to [SDK Reference](/sdk-reference/manual/index).
