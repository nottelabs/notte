...
For the API surface, see <Visibility for="humans">[API Reference](/api-reference/authentication)</Visibility><Visibility for="agents">[API Reference](/api-reference/authentication.md)</Visibility>; for the SDK entrypoint, see [SDK Reference](/sdk-reference/manual/index).
