...
Notte provides a hosted MCP server focused specifically on browser control, enabling you to ask Claude or Cursor to act on your behalf on the web directly from the chat interface.
