...
[Massive](https://www.joinmassive.com/) is a residential proxy provider offering ethically-sourced IPs across 195+ countries. If you have a Massive account (or are considering one), you can plug their proxies directly into your Notte sessions using the <Visibility for="humans">[`ExternalProxy`](/features/sessions/proxies#custom-proxies)</Visibility><Visibility for="agents">[`ExternalProxy`](/features/sessions/proxies.md#custom-proxies)</Visibility> type.
