...
<CardGroup cols={4}>
  <Card title="Proxies" icon="stop" href="/side/features/proxies">
    Avoid being blocked by CAPTCHAs and other anti-bot measures.
  </Card>
  <Card title="CDP" icon="square-terminal" href="/side/features/cdp">
    Connect to remote sessions through `playwright`.
  </Card>
  <Card title="Replays" icon="play" href="/side/features/session-replay">
    Replay your sessions and debug them with ease.
  </Card>
  <Card title="Cookies" icon="cookie" href="/side/features/cookies">
