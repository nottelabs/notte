...
!<Visibility for="humans">[vault-fill-action](/images/vault-fill-action.png)</Visibility><Visibility for="agents">[vault-fill-action](/images/vault-fill-action.png.md)</Visibility>
