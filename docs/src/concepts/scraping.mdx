...
Fetch extracts web page content as markdown or structured data using LLM-powered extraction. In the SDK this is `scrape`. In the console it is [Fetch](https://console.notte.cc).
...
<CardGroup cols={2}>
  ...
  <Card title="Search" icon="magnifying-glass" href="/concepts/search">
    Find pages before you fetch them
  </Card>
