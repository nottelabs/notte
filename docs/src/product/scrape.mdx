...
<CodeGroup>
  ...
  with client.Session() as session:
      session.execute(actions.Goto(url="https://example.com/blog"))
...
<CodeGroup>
  ...
  with client.Session() as session:
      session.execute(actions.Goto(url="https://example.com/category/laptops"))
...
<CodeGroup>
  ...
  with client.Session() as session:
      session.execute(actions.Goto(url="https://directory.example.com"))
...
<CodeGroup>
  ...
  with client.Session() as session:
      session.execute(actions.Goto(url="https://news.example.com"))
...
<CodeGroup>
  ...
  with client.Session() as session:
      ...
      for page in range(1, 6):  # Scrape 5 pages
          ...
          # Go to next page
          session.execute(actions.Click(selector="a.next-page"))
...
<CodeGroup>
  ...
  with client.Session() as session:
      session.execute(actions.Goto(url="https://example.com/jobs"))
...
<CodeGroup>
  ...
  with client.Session() as session:
      session.execute(actions.Goto(url="https://example.com/product/123"))
